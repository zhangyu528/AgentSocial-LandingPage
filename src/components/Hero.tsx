                ...
                <div className="p-6 font-mono text-sm leading-relaxed space-y-4">
                  <div className="flex gap-3">
                    ...
                    <span className="text-green-400">
                      agentsocial run --provider claude
                    </span>
                  </div>
                  ...
                  <div className="pt-4 border-t border-white/5">
                    <div className="bg-primary/10 border border-primary/20 rounded p-3">
                      <div className="text-xs text-primary mb-1 uppercase font-bold">
                        Incoming Task via Feishu
                      </div>
                      <div className="italic text-white/70">
                        "Optimize the database indexing for the users table and report back."
                      </div>
                    </div>
                  </div>
                </div>
