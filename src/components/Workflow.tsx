          ...
          <div className="grid lg:grid-cols-4 gap-12">
            {workflowData.steps.map((step, index) => (
              <div key={index} className="relative z-10 text-center lg:text-left">
                <div className={`w-24 h-24 mx-auto lg:mx-0 rounded-3xl flex items-center justify-center mb-6 ring-8 ring-white dark:ring-background-dark ${index === 0 ? "bg-primary text-white shadow-xl shadow-primary/30" : "bg-white dark:bg-card-dark border-2 border-slate-200 dark:border-border-dark text-primary"}`}>
